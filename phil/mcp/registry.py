"""Persistent dataset / run / upload registry for the Phil MCP server."""
...
@dataclass
class RunRecord:
    """Persistent record describing a finished Phil imputation sweep."""
...
class MCPRegistry:
    """Small persistent registry for MCP dataset, run, and upload handles."""
    ...
    def register_dataset_from_file(
        ...
        *,
        ...
        """Register a dataset from an existing file using a streaming move."""
        with self._locked_registry():
