...
class CovariateDistributionImputer(BaseEstimator):
    ...
    Unlike :class:`DistributionImputer`, which samples from the marginal
    distribution of observed values, this imputer conditions on the other
    available covariates to preserve covariate structure.
    """
